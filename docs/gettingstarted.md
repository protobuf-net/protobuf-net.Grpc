...
3. in `ConfigureServices`, call `services.AddGrpc()` and `services.AddCodeFirstGrpc()`; see [`Startup.cs`](https://github.com/protobuf-net/protobuf-net.Grpc/blob/master/examples/pb-net-grpc/Server_CS/Startup.cs)
